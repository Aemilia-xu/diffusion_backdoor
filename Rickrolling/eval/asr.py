...
def main(args):
    ...
    processor = ViTImageProcessor.from_pretrained('/data_19/pretrained_model/google/vit-base-patch16-224')
    model = ViTForImageClassification.from_pretrained('/data_19/pretrained_model/google/vit-base-patch16-224').to('cuda')
